...
public:
    ...
    static void cantGiveMoney(TgBot::Bot* bot, int64_t id);
    
    static void cantSeeClassification(TgBot::Bot* bot, int64_t id);

    static void cantStake(TgBot::Bot* bot, int64_t id);
